...
class Alert:
    ...
    def send(self, priority, endpoint):
        if priority == 'high':
            failure_type = 'Type 2'
            ...
            db_alert = DB_Alert(endpoint_id=endpoint['id'], failure_type=failure_type, start_time=now)
